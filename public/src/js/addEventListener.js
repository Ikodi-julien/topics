...
export const addEventListener = {
   ...
   */
  userInfo: () => {
    if (document.getElementById('infoMessage').textContent.trim.length) showInfo();
    document.getElementById('infouserButton').addEventListener('click', showInfo);
  },
  
  profile: function() {

    const showButtons = document.querySelectorAll('.profile__formContainer__titleRow');
